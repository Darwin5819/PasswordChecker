...
class MyGUI:
    ...
    def __init__(self):
        ...
        self.root.title('Password Validator by: @Darwin5819')
        ...
        self.check_frame = tk.Frame(
            self.root, highlightbackground="grey", highlightthickness=2)
